...
var places = [	"Metropolis, Bogotá D.C., Bogota, Colombia", 
				"Soacha", 
				"Usaquen",
				"Museo Del Oro, Bogota, Colombia",
				"Centro Comercial Unicentro De Occidente - Carrera 111A, Cuidadela Colsubsidio, Bogota, Colombia",
				"Armando Records, Bogota - Cundinamarca, Colombia",
				"Universidad Nacional, Teusaquillo, Bogota, Colombia",
				"La Piscina Club Internacional, Bogota - Cundinamarca, Colombia",
				"Quintanares, Bogota, Colombia",
				"Calle 72 # 7, Bogota - Cundinamarca, Colombia",
				"Portal Usme, Bogota - Cundinamarca, Colombia",
				"El Dorado, Bogota - Cundinamarca, Colombia",
				"Zona Franca de Bogota, Bogota, Colombia",
				"Chia, Colombia",
				"La Calera, Colombia",
				"Plazoleta del Chorro de Quevedo - Calle 13, La Concordia, Bogota, Colombia"];

//super hack to ramdom array
...
function initialize() {
  ...
  var latlng = new google.maps.LatLng(4.5980556,-74.0758333);
